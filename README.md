...
> Versao atual: **v5.0.2** (pacote revisado e atualizado em 17/08/2026).
...
<div align="center">
  <a href="https://github.com/OtavioBiazzi/Youtube-ad-skipper/releases/download/v5.0.2/youtube-extension-v5.0.2.zip">
    <img src="https://img.shields.io/badge/Baixar_Vers%C3%A3o_5.0.2_(.ZIP)-000000?style=for-the-badge&logo=github&logoColor=white" alt="Baixar YouTube Extension 5.0.2" />
  </a>
  <br><br>
...
1. **[Baixe o pacote pronto da versão 5.0.2](https://github.com/OtavioBiazzi/Youtube-ad-skipper/releases/download/v5.0.2/youtube-extension-v5.0.2.zip)**.
2. **Extraia (descompacte)** o arquivo `youtube-extension-v5.0.2.zip` em uma pasta permanente no seu computador.
